...
export default function Footer() {
  return (
    <footer className="bg-amber-50 text-gray-800 py-10 mt-10">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center space-y-6">
        ...
        <nav className="flex flex-wrap justify-center gap-6 text-base font-medium">
          ...
          <a href="#" className="hover:text-yellow-500 transition">Jobs</a>
          <a href="#" className="hover:text-yellow-500 transition">Press Kit</a>
        </nav>
        ...
        <div className="border-t border-gray-300 w-full mt-6 pt-4">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} <span className="font-semibold">SkillSwap</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
